...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      /* Hide cursor on ALL elements so pointer/text cursors don't flash */
      const globalStyle = document.createElement('style');
      globalStyle.id = 'target-cursor-hide';
    ...
    return () => {
      ...
      const globalStyle = document.getElementById('target-cursor-hide');
  ...
  return (
    <div ref={cursorRef} style={wrapperStyle}>
      <div ref={dotRef} style={dotStyle} />
      {corners.map((style, i) => (
        <div key={i} className="target-cursor-corner" style={style} />
      ))}
    </div>
  );
};
